...
```sh
% mvn -B archetype:generate -DgroupId=com.example -DartifactId=wilderness -Dversion=1.0.0-SNAPSHOT -DarchetypeArtifactId=maven-archetype-quickstart
```
...
```sh
% java -jar target/wilderness-1.0.0-SNAPSHOT.jar
```
